 ...
 * @author RONALDMO
 */
public class frmAddJugador extends javax.swing.JDialog {

    /**
     * Creates new form frmAddJugador
     */
    public frmAddJugador(java.awt.Frame parent, boolean modal) {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddJugador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new frmAddJugador().setVisible(true);
                frmAddJugador dialog = new frmAddJugador(new javax.swing.JFrame(), true);
